...
BEGIN getRelativePositions(playerID, worldOctree)
    ...
    Let ObjectsArray() = playerOctreePose.getParent().getParent().getParent().getParent().Objects
    ...
    FOR i = 0 to objectAmount STEP 1
        ...
        ELSE
            ...
            relativePositions(j).RotationW = playerOctreePose.RotationW.lookingAt(ObjectsArray(j).RotationW)   
            relativePositions(j).RotationX = playerOctreePose.RotationX.lookingAt(ObjectsArray(j).RotationX) 
            relativePositions(j).RotationY = playerOctreePose.RotationY.lookingAt(ObjectsArray(j).RotationY) 
            relativePositions(j).RotationZ = playerOctreePose.RotationZ.lookingAt(ObjectsArray(j).RotationZ) 
        ENDIF        
    NEXT i
