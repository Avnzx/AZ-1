...
WorldGenerator & Contains code required to  \\ \hline
AudioManager & Contains code required to  \\ \hline
...
Function & Module & Description \\
    \hline \hline \\
Level of Detail Manager & Renderer & Contains code required to  \\ \hline
Process Planets & GameServer & Contains code required to  \\ \hline
Process collisions & GameClient & Contains code required to  \\ \hline
Connect to Server & Join Game & Contains code required to  \\ \hline
Switch Weapons & WeaponManager & Contains code required to  \\ \hline
...
Player input event has ocurred & Calculate how far they are allowed to move and kick them if exceeded. Update the objects in their vicinity to provide faster simulation & User sees the game run smoothly \\ 
    \hline
\end{xltabular}
...
%     "states" : \{
%     "stationaryShoot" : \{
%     "behaviour" : \["shoot radialShotgun 2", "stateChangeTime waitTimer 6
%     wait"\]
%     \},
%     "wait" : \{
...
Data Item & Data Type & Format & Number of Bytes required for storage & Size for display & Description  & Example & Validation \\
    \hline \hline \\
Player Name & string & NNNNNNNNNNNNNNNNNNNN & 20 & 20 & A unique name for each player to pick & Avnzx & Name must not exist in the system, name must only consist of valid UTF-8 characters, cannot be comprised only of UTF-8 "invisible" characters \\ \hline
Planet & Planet (custom) & stuff & stuff & stuff & stuff & stuff & stuff \\ \hline
FuelAmount & floating point & stuff & stuff & stuff & stuff & stuff & stuff \\ \hline
Object ID & stuff & stuff & stuff & stuff & SHA256Sum representing an object that must be sent from the server to the client or the client to the server. Utilised for any communication, as well as modding to determine what resources need to be transferred between the systems. Will be utilised e.g. when downloading mods for a server it will check for the correct SHA256Sum's and deploy them onto your computer if you do not have them. & e79352f60b20180370436003d76bbce59ce86a29288e1ba2322cbb06ade3e871 & Not Validated as is automatically generated by the system, will be checked for corruption \\ \hline
MovementSpeed & stuff & stuff & stuff & stuff & stuff & stuff & stuff \\ \hline
PlayersRegistered & stuff & stuff & stuff & stuff & stuff & stuff & stuff \\ \hline
PlayerOctreePose & stuff & stuff & stuff & stuff & stuff & stuff & stuff \\ \hline
WorldOctree & stuff & stuff & stuff & stuff & stuff & stuff & stuff \\ \hline
CurrentTime & stuff & stuff & stuff & stuff & stuff & stuff & stuff \\ \hline
PlanetPositionDifference & stuff & stuff & stuff & stuff & stuff & stuff & stuff \\ \hline
    \hline
\end{xltabular}
\end{alscape}
