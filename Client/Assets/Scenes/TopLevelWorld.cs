...
public partial class TopLevelWorld : Node3D
{
	...
	public Dictionary<uint,BaseBullet> bulletList = new Dictionary<uint, BaseBullet>();
	public Dictionary<uint,PlanetType> planetList = new Dictionary<uint, PlanetType>();
	public Dictionary<uint,Node3D> modelList = new Dictionary<uint, Node3D>();
	// List<PlayerType>
}
